...
?>
	...
	<label> <b>NOTA:</b> El tiempo de duración de la  conversión de los archivos txt a excel dependera del tamaño del archivo a convertir o del numero de registros o movimientos que contenga. </label>	
	<hr>
	</br>
	...
	<div class="draganddrop" ondrop="drop(event)" ondragover="dragover(event)" ondragenter="dragenter(event)" id="dragFile">
     ...
     <span><input type="button" style="float: right; margin-right: 15px;" id="5statesimportfile_btn" class="gray2" value="<?php echo('Convertir Archivo'); ?>" disabled="disabled" onclick="importFileExcelPoints(this, 1)" ></span>
