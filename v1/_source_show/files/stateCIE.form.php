...
?>
	...
	<div class="draganddrop" ondrop="drop(event)" ondragover="dragover(event)" ondragenter="dragenter(event)" id="dragFile">
     ...
     <span><input type="button" style="float: right; margin-right: 15px;" id="5stateCIEFilePointExcel_btn" class="gray2" value="<?php echo('Convertir Archivo'); ?>" disabled="disabled" onclick="importFileExcelPoints(this, 4)" ></span>
