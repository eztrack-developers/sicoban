               ...
               <tr>
                ...
                <tr>
                  ...
                  <td height="7px" colspan="3">
                    <input type="button" class="button-session" onclick="sessionStart()" value="<?php echo('ENTRAR'); ?>">
                  </td>
                </tr>
                ...
                <tr>
                    <td>
                       <a class="button-session-account" onclick="window.location.href='http://www.sicoban.mx/register-clients/'">REGISTRATE</a>
                    </td>
